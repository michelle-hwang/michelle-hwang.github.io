...
* There are 3 types of queues (1) public, (2) private, and (3) presonal
...
* There are two types of entitlements (1) Standard and (2) Enhanced
* Entitlement statuses include Draft, Waiting, Active, Expired, Canceled
* Enhanced entitlements allow pausing, 
